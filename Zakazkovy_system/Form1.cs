...
namespace Zakazkovy_system
{
    ...
    public partial class Form_Mainwindow : Form
    {
        ...
        //{
        //    if (textBox_Cislo_zakazky.Text != "")
        //    {
        //        BarcodeLib.Barcode b = new BarcodeLib.Barcode(textBox_Cislo_zakazky.Text, TYPE.CODE128);
        //        b.Encode(TYPE.CODE128, comboBox_Search_field.Text, Color.Black, Color.White, 300, 150);
        //        b.SaveImage("Barcode0001.jpg", SaveTypes.JPG);
                
        //    }
        //    else
        //    {
        //        MessageBox.Show("Nezvolena Zakázka, nelze vytisknout čárový kód.", "čárový kód", MessageBoxButtons.OK, MessageBoxIcon.Error);
        //    }
        ...
        {
            System.Drawing.Image img = System.Drawing.Image.FromFile("Barcode0001.jpg");
        ...
        private void tiskČárovéhoKóduToolStripMenuItem_Click(object sender, EventArgs e)
        {
        //    BarcodePrint();
        }
